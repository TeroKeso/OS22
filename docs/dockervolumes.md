...
/ #
```
- To interact with the shell when the container is already running. You will need to find the ID of the container using docker ps or Docker Desktop
```
PS D:\github\OS22> docker exec -it d99_NAMEtaiID_991 /bin/sh
/ #
```
